...
COMMON_ALIASES = {
    ...
    'department_code': ['departmentcode', 'deptcode', 'dept_code', 'department_id', 'dept_id', 'department', 'department code', 'department_code', 'code', 'dept'],
    'department_codes': ['departmentcodes', 'deptcodes', 'dept_codes', 'departments', 'department codes', 'department_codes', 'code', 'dept', 'department_code', 'dept_code'],
